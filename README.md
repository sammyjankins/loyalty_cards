On the main page there is a table with filters. Each card, except for expired ones, can be activated and deactivated. All cards can be removed. The list is paginated by 10 items.
